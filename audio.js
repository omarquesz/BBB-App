...
// ─── Play / Pause — ÚNICO ponto de contato com AudioContext ─
async function togglePlay() {
  ...
  // ── DENTRO DO GESTO: AudioContext pode ser criado/resumido ──
  const ac = await ensureCtxRunning();

  // Decodificar tudo que ainda não foi decodificado
